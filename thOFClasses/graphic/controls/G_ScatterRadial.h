...
#ifndef _G_ScatterRadial
#define _G_ScatterRadial
...
class G_ScatterRadial : public G{ //style missing
...
public:
	...
	// poco event stuff ---------
	BasicEvent<ofVec2f> onDrag;
	BasicEvent<int> onPress;
    BasicEvent<int> onRelease;
	
	void dispatchOnDrag (ofVec2f response) {
